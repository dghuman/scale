...
def daq_stream(arduino, n_data=100, delay=100):
    ...
    return time_ms, weight #pd.DataFrame({'time (ms)': time_ms, 'weight (kg)': weight})
...
if __name__ == '__main__':
    ...
    time = time_ms/1000 #df['time (ms)'].to_numpy().astype(float)/1000
